                      ...
                      <tr>
                        ...
                        <?php
                          if($row['active'] == '1') {
                            ...
                            ?>
                            <a href="reject-company.php?id=<?php echo $row['id_company']; ?>"><b>Reject</b></a> <a href="approve-company.php?id=<?php echo $row['id_company']; ?>"><b>Approve</b></a>
                            <?php
                          } else if ($row['active'] == '3') {
                            ?>
                              <a href="approve-company.php?id=<?php echo $row['id_company']; ?>"><b>Reactivate</b></a>
                            <?php
                        ...
                        <td><a href="delete-company.php?id=<?php echo $row['id_company']; ?>"><b>Delete</b></a></td>
                      </tr>
                     <?php
                        }
                      }
