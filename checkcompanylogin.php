...
if(isset($_POST)) {
	...
	if($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			if($row['active'] == '2') {
				$_SESSION['companyLoginError'] = "<b>Your Account Is Still Pending Approval By Admin!</b>";
				header("Location: login-company.php");
				exit();
			} else if($row['active'] == '0') {
				$_SESSION['companyLoginError'] = "<b>Your Account Is Rejected, Please Contact Admin For More Information!</b>";
				header("Location: login-company.php");
				exit();
				...
				$_SESSION['companyLoginError'] = "<b>Your Account Is Deactivated, Contact Admin For Reactivation!</b>";
				header("Location: login-company.php");
				exit();
			}
		}
