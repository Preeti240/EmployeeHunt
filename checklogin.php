...
if(isset($_POST)) {
	...
	if($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			if($row['active'] == '0') {
				$_SESSION['loginActiveError'] = "<b>Your Account Is Not Active, Check Your Email!</b>";
				...
				$_SESSION['loginActiveError'] = "<b>Your Account Is Deactivated, Contact Admin To Reactivate!</b>";
		 		header("Location: login-candidates.php");
				exit();
			}
