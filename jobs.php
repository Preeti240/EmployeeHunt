    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          ...
          <h2 class="text-center"><b>Latest Jobs</b></h2>
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="" class="citySearch" data-target="Indore"><i class="fa fa-circle-o text-yellow"></i> Indore</a></li>
                    </ul>
                  </li>

                  <li class="treeview menu-open">
                    <a href="#"><i class="fa fa-history text-red"></i> Experience <span class="pull-right"><i class="fa fa-angle-down pull-right"></i></span></a>
                    <ul class="treeview-menu">
                  ...
                  <li class="treeview menu-open">
                    <a href="#"><i class="fa fa-graduation-cap text-red"></i> Branch <span class="pull-right"><i class="fa fa-angle-down pull-right"></i></span></a>
                    <ul class="treeview-menu">
                      <li><a href="" class="experienceSearch" data-target='CSE'><i class="fa fa-circle-o text-yellow"></i> Computer Science</a></li>
                      <li><a href="" class="experienceSearch" data-target='ENTC'><i class="fa fa-circle-o text-yellow"></i> ENTC</a></li>
                      <li><a href="" class="experienceSearch" data-target='Mech'><i class="fa fa-circle-o text-yellow"></i> Mechanical Engineering</a></li>
                      <li><a href="" class="experienceSearch" data-target='IT'><i class="fa fa-circle-o text-yellow"></i> Information Technology</a></li>
                      <li><a href="" class="experienceSearch" data-target='Civil'><i class="fa fa-circle-o text-yellow"></i> Civil Engineering</a></li>
                    </ul>
                  </li>
