...
<div class="login-box">
  <div class="login-logo">
    <a style="color:darkblue" href="index.php"><b>EmployeeHunt</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <h4 class="login-box-msg"><b>Candidates Login</b></h4>
    ...
    if(isset($_SESSION['registerCompleted'])) {
      ?>
      <div>
        <p id="successMessage" class="text-center"><b>Check your email!</b></p>
      </div>
    <?php
    ...
    if(isset($_SESSION['loginError'])) {
      ?>
      <div>
        <p class="text-center"><b>Invalid Email / Password! Try Again!</b></p>
      </div>
    <?php
    ...
    if(isset($_SESSION['userActivated'])) {
      ?>
      <div>
        <p class="text-center"><b>Your Account Is Active, You Can Login! </b></p>
      </div>
    <?php
