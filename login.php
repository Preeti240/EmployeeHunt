    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20">
          <h2 class="text-center margin-bottom-20"><b>Login As..</h2></b><br><br>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-yellow padding-3">
              <div class="inner">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-3">
              <div class="inner">
          ...
          <div class="col-md-12 latest-job ">
            <div class="small-box bg-blue padding-3">
              <div class="inner">
